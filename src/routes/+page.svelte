						...
						>
							<div class="lg:py-24">
								...
								<p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
									Join the Ovik.dev hackathon and be part of a community that's making a difference.
									Collaborate with like-minded individuals and tackle some of our daily challenges
								...
								<div class="mt-10 sm:mt-12">
									<form action="#" class="sm:mx-auto sm:max-w-xl lg:mx-0">
										...
										<p class="mt-3 text-sm text-gray-300 sm:mt-4">
											By signing up you will only recive more information about this and future
											events. This is not a registration for the event.
										</p>
									</form>
								</div>
							</div>
			...
			<section class="relative bg-white py-16 sm:py-24 lg:py-32">
				<div class="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
					...
					<p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
						An enviroment where everyone is included
					</p>
					<p class="mx-auto mt-5 max-w-prose text-xl text-gray-500">
						We want everyone to feel included and free to speak there mind with the same goal of
						building awesome solutions. If you don't feel this please reach out to closest
						organizer.
					</p>
					<div class="mt-12">
				...
				>
					<div class="md:ml-auto md:w-1/2 md:pl-10">
						...
						<p class="mt-3 text-lg text-gray-300">
							...
							Contact information exist in the signup email.<br /><br />Want to help out? Feel free
							to reach out to us via the signup email where you will find our contact information.
						</p>
						<div class="mt-8">
				...
				<div class="xl:grid xl:grid-cols-1 xl:gap-8">
					<div class="space-y-8 xl:col-span-1">
						...
						<p class="text-base text-gray-200">
							Doing all we can to support entrepreneurs solving the real and critical problems that
